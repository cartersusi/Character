...
public:
    ...
    void InitRender(glm::mat4& model, unsigned int shaderProgram, float torsoPositionX, float torsoPositionY) {
        ...
        lfn(model, shaderProgram, LeftArmTexture, torsoPositionX + (TorsoSize * 0.25), torsoPositionY, LeftArmSize, LeftArmSize);
        ...
        lfn(model, shaderProgram, RightArmTexture, torsoPositionX - (TorsoSize * 0.25), torsoPositionY + 0.5f, RightArmSize, RightArmSize);
    }
...
int main()
{
    ...
    unsigned int backgorundTexture = loadTexture("pngs/bg_1440_900.png");
    ...
    float torsoPositionY = goblin.LeftLegSize;
